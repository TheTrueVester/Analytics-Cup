...
TP <- count(train_set_with_predictions %>% filter(.pred_class == "1" & Reseller == "1"))
TP
TN <- count(train_set_with_predictions %>% filter(.pred_class == "0" & Reseller == "0"))
TN
FP <- count(train_set_with_predictions %>% filter(.pred_class == "1" & Reseller == "0"))
FP
FN <- count(train_set_with_predictions %>% filter(.pred_class == "0" & Reseller == "1"))
FN
